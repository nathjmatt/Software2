...
public final class CountPrimitiveCallsTest {
    ...
    public void testIfElsetrue() {
        Statement s1 = this.createFromArgs("data/testIfElse.bl", true);
        Statement s2 = this.createFromArgs("data/testIfElse.bl", true);
        int count = CountPrimitiveCalls.countOfPrimitiveCalls(s1);
    ...
    public void testCalltrue() {
        Statement s1 = this.createFromArgs("data/testCall.bl", true);
        Statement s2 = this.createFromArgs("data/testCall.bl", true);
        int count = CountPrimitiveCalls.countOfPrimitiveCalls(s1);
        assertEquals(6, count);
        assertEquals(s2, s1);
    }
