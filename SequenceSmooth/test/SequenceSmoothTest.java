...
public final class SequenceSmoothTest {
    ...
    /**
     * Test smooth with s1 = <2, 4, 6, 8, 10> and s2 = <3, 4, 5, 6, 7>.
     */
    @Test
    public void test4() {
        /*
        ...
        Sequence<Integer> seq2 = this.createFromArgs(3, 4, 5, 6, 7);
    ...
    /**
     * Test smooth with s1 = <-2, 4, 6> and s2 = <-5, 10, 3>.
     */
    @Test
    public void test5() {
        /*
        ...
        Sequence<Integer> seq1 = this.createFromArgs(-2, 4, 6);
        Sequence<Integer> expectedSeq1 = this.createFromArgs(-2, 4, 6);
        Sequence<Integer> seq2 = this.createFromArgs(-5, 10, 3);
        Sequence<Integer> expectedSeq2 = this.createFromArgs(1, 5);
        SequenceSmooth.smooth(seq1, seq2);
        /*
         * Assert that values of variables match expectations
         */
    ...
    /**
     * Test smooth with s1 = <222333444, 289765432> and s2 = <10, 3>.
     */
    @Test
    public void test7() {
        /*
         * Set up variables and call method under test
         */
        Sequence<Integer> seq1 = this.createFromArgs(222333444, 289765432);
        Sequence<Integer> expectedSeq1 = this.createFromArgs(222333444,
                289765432);
        Sequence<Integer> seq2 = this.createFromArgs(10, 3);
        Sequence<Integer> expectedSeq2 = this.createFromArgs(256049438);
        SequenceSmooth.smooth(seq1, seq2);
        /*
         * Assert that values of variables match expectations
         */
